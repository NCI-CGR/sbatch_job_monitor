...
#ifndef SBATCH_JOB_MONITOR_CARGS_H_
#define SBATCH_JOB_MONITOR_CARGS_H_
...
class cargs {
 public:
  ...
  unsigned get_eqw_resub_limit() const {
    return compute_parameter<unsigned>("error-resub-limit");
  }
  /*!
...
#endif  // SBATCH_JOB_MONITOR_CARGS_H_
